    ...
    render() {
        ...
        let children = this.data.map((url, currentPosition) => {
            ...
            let onPanend = (event) => {
                ...
                // let currentTransformValue = - 500 * currentPosition + offset + direction * 500;
                // let lastTransformValue = -500 - 500 * lastPosition + offset + direction * 500;
                // let nextTransformValue = 500 - 500 * nextPosition + offset + direction * 500;
                let lastElement = children[lastPosition];
                let currentElement = children[currentPosition];
                let nextElement = children[nextPosition];
